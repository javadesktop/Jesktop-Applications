...
/* Fixed a minor bug that kept browser from launching on Solaris (NETSCAPE_OPEN_PARAMETER_START doesn't work with "'")
 * and added main class driver so that changes could be easily checked. Haven't verified against other Unix flavors.
 *  Aaron Miller (<a href="mailto:aaronmiller@hotmail.com">aaronmiller@hotmail.com</a>)
 */
